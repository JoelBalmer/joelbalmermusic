...
$(window).scroll(function() {
    if ($(".navbar").offset().top > 50) {
        ...
        if ($(window).width() > 768) {
            $(
                "#page-top > nav > div > div.navbar-collapse.navbar-right.navbar-main-collapse.collapse > ul > li:nth-child(2)"
            ).removeClass("active");
        }
    } else {
...
$(document).ready(function() {
    ...
    if ($(window).width() > 768) {
        var aboutListItem = $(
            "#page-top > nav > div > div.collapse.navbar-collapse.navbar-right.navbar-main-collapse > ul > li:nth-child(2)"
        );
...
$(function() {
    $("a.page-scroll").bind("click", function(event) {
        if (
            this.getAttribute("id") === "work-menu-item" &&
            !workMenuIsVisible
        ) {
